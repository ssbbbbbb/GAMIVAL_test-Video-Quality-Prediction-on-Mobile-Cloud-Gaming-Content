...
def arg_parser():
    ...
    parser.add_argument('--feature_file', type=str, default='E:/FOLDER/computer_vision/GAMIVAL-main/feat_files/LIVE-Meta-Mobile-Cloud-Gaming_GAMIVAL_bicubic_feats.mat')
    ...
    parser.add_argument('--num_iterations', type=int, default=6)  # Set to 6
